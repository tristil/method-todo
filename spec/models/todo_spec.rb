...
describe Todo do
  ...
  it "sets each ranking to 0 and updates other todos' rankings, per user" do
    ...
    todo1.user = user
    todo1.save!
    todo1.ranking.should eq 0

    todo2 = Todo.new(description: 'Do something else')
    todo2.user = user
    todo2.save!
    todo2.ranking.should eq 0
    todo1.reload.ranking.should eq 1

    todo3 = Todo.new(description: 'Do yet another thing')
    todo3.user = user2
    todo3.save!
    todo3.ranking.should eq 0
    todo2.reload.ranking.should eq 0
    todo1.reload.ranking.should eq 1
  end
  ...
  describe '#for_options' do
    ...
    it 'returns active todos if completed is not passed in' do
      todo2.complete
      todo2.save!
      Todo.for_options.should eq [todo1, todo3]
    end
    ...
    it "returns 'tickler' todos if tickler is passed in" do
      ...
      todo3.tickler = true
      todo3.save!
      Todo.for_options(tickler: true).should eq [todo1, todo3]
    end
    ...
    it 'returns completed todos if completed is passed in' do
      ...
      todo3.complete
      todo3.save!
      Todo.for_options(completed: 1).should eq [todo1, todo3]
    end
    ...
    it 'returns todos for a context if context_id is passed in' do
      ...
      Todo.for_options(context_id: context1.id).should eq [todo1, todo3]
    end
    ...
    it 'returns todos for a tag if tag_id is passed in' do
      ...
      todo2.tags << tag2
      todo3.tags << tag
      Todo.for_options(tag_id: tag.id).should eq [todo1, todo3]
    end
    ...
    it 'returns todos for a project if project_id is passed in' do
      ...
      todo3.save!
      Todo.for_options(project_id: project.id).should eq [todo1, todo3]
    end
  end
  ...
  specify '#uncomplete marks record as not completed and clears completed' \
          'time' do
    todo = Todo.create(description: 'A New Todo')
    todo.uncomplete
    todo.save!
  ...
  specify '#destroy uses Acts as Paranoid to virtually delete the todo' do
    ...
    todo.destroy
    Todo.all.should eq []
    Todo.only_deleted.should eq [todo]
  end
  ...
  specify '#todo_contexts returns contexts of this todo' do
    ...
    todo.save!
    todo.reload
    todo.todo_contexts.should eq [todo_context]
  end
  ...
  specify '#todo_context returns the first context' do
    ...
    todo.save!
    todo.reload
    todo.todo_context.should eq todo_context
  end
  ...
  specify '#project returns the project' do
    ...
    todo.save!
    todo.reload
    todo.project.should eq project
  end
end
...
describe Todo, '#parse' do
  it 'adds or creates a new Project when it detects +' do
    ...
    todo.save!
    todo.parse
    todo.project.name.should eq 'report'
    ...
    todo2.save!
    todo2.parse
    todo2.project.should eq todo.project
  ...
  it 'adds or creates a new Context when it detects @' do
    ...
    todo.save!
    todo.parse
    todo.todo_contexts.first.name.should eq 'home'
    ...
    todo2.parse
    todo2.reload
    todo2.todo_contexts.should eq todo.todo_contexts
  end
  ...
  it 'adds or creates a new Tag when it detects #' do
    ...
    todo.save!
    todo.parse
    todo.tags.first.name.should eq 'homework'
    ...
    todo2.parse
    todo2.reload
    todo2.tags.should eq todo.tags
  end
  ...
  it 're-parses line if data seems out of sync' do
    ...
    todo.user = user
    todo.save!
    -> { todo.parsed_description }.should_not raise_error
  ...
  it '#parsed_description outputs correct line html' do
    ...
    todo.save!
    todo.parse
    todo.parsed_description.should eq 'Write report'

    todo.description = 'Write first draft +report'
    todo.save!
    todo.parse
    todo.parsed_description.should eq(
      'Write first draft ' \
      "<a href='#' class='project-badge-1 todo-badge'>" \
      "<span class='label label-default'>+report</span></a>")

    todo.description = 'Write report @home'
    todo.save!
    todo.parse
    todo.parsed_description.should eq(
      "Write report <a href='#' class='context-badge-1 todo-badge'>" \
      "<span class='label label-default'>@home</span></a>")

    todo.description = 'Write report #homework'
    todo.save!
    todo.parse
    todo.parsed_description.should eq(
      "Write report <a href='#' class='tag-badge-1 todo-badge'>" \
      "<span class='label label-default'>#homework</span></a>")

    todo.description = 'Write first draft +report @home #homework'
    todo.save!
    todo.parse
    todo.parsed_description.should eq(
      "Write first draft <a href='#' class='project-badge-1 todo-badge'>" \
      "<span class='label label-default'>+report</span></a> " \
      "<a href='#' class='context-badge-1 todo-badge'>" \
      "<span class='label label-default'>@home</span></a> " \
      "<a href='#' class='tag-badge-1 todo-badge'>" \
      "<span class='label label-default'>#homework</span></a>")
    ...
    Timecop.freeze(Date.new(2012, 5, 1)) do
      ...
      todo.save!
      todo.parsed_description.should eq(
        "Write first draft <a href='#' class='tag-badge-1 todo-badge'>" \
        "<span class='label label-default'>#homework</span></a> " \
  ...
  it "#local_completed_time returns value for current_user's timezone" do
    ...
    todo.local_completed_time.to_formatted_s(:american).should eq '5/01/2012'

    user.preferences[:timezone_offset] = 0
    user.save!

    todo.local_completed_time.to_formatted_s(:american).should eq '5/02/2012'
  end
end
...
describe Todo, '#strip_text' do
  it 'removes text from description' do
    ...
    user.todos.strip_text! '+report'

    todo.reload.description.should eq 'Write first draft @home'
    todo2.reload.description.should eq 'Write final draft @work'
  end
end
